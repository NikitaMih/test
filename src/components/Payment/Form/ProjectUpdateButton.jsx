...
import { updateProjects } from '../../../reducers/payment-reducer';
import { useDispatch } from 'react-redux';

const ProjectUpdateButton = (props) => {
    //Статус кнопки "обновить проекты"
    const [isUpdatingProjects, setUpdatingProjects] = useState(false);
    
    const dispatch = useDispatch();

    /**
     * Метод обновления списка проектов по сайту
     * @returns 
     */
